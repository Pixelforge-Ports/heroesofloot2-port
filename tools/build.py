"""Build the Heroes of Loot 2 PortMaster host and BYO-data ZIP without proprietary game data."""
import argparse
import hashlib
import os
...
SHA256 = '67cff11e557a3660c4276058a3ebc62b03938a1ab4822652d48abf31b273c9e6'
...
def main():
    ...
    if args.package_only:
        if not (ROOT/'package/heroesofloot2/runtime/heroesofloot2-host.jar').is_file():
    ...
    runtime = ROOT/'package/heroesofloot2/runtime'
    runtime.mkdir(parents=True, exist_ok=True)
    with zipfile.ZipFile(runtime/'heroesofloot2-host.jar', 'w') as out:
        # Only adaptation classes ship. Compile declarations and libraries never do.
        for path in sorted((classes/'org/portmaster/heroesofloot2').rglob('*.class')):
