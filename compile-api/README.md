...
Only org/portmaster/heroesofloot2 classes are written to heroesofloot2-host.jar. All
com/orangepixel declarations and open-source dependencies are excluded. The player
supplies the unchanged supported heroesofloot2.jar for the real runtime implementation.
